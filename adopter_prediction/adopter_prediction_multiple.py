...
par_m = 8
distance_metric_set = 3 # 0-Hausdorff, 1-m, 2-avg, 3-most distant
top_k = 500
seq_len_threshold = top_k #500
print vec_file, num_init_adopters, distance_metric_set, par_m, top_k
