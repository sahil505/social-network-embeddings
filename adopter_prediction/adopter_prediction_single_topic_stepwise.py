...
print vec_file, num_init_adopters, metric_Hausdorff_m_avg, top_k, train_ex_limit, top_k_test, next_k
...
with open("adopter_pred_files/single_topic_train_test_files/eval_n"+str(num_init_adopters)+"_rf_prec"+str(top_k_test)+"_step"+str(next_k)+".pickle","wb") as fd:
...
print vec_file, num_init_adopters, metric_Hausdorff_m_avg, top_k, top_k_test, next_k