...
neigh.fit(vec)
toc = time.clock()
print "kdtree built in", (toc-tic)*1000
...
with open("adopter_pred_files/single_topic_train_test_files/mean_precision_n"+str(num_init_adopters)+"_rf_prec"+str(top_k_test)+".pickle","wb") as fd:
