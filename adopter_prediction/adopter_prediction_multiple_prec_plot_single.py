...
top_k = [1,2,5]+range(10,101,10) #[100,200,300]+range(500,5001,500)
...
for i in seq_random_index:
	...
	for top_k_i in top_k:
		...
		print "Nb_App", "Avg precision", average_precision_nbapp, "Precision", prec_k_nbapp, "Recall", rec_k_nbapp, "k", N
...
with open("prec_plot_single1.pickle","wb") as fd:
